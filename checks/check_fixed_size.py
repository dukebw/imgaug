...
def main():
    ...
    augs_many = [
        ...
        iaa.PadToFixedSize(
            480, 322, name="pad-width480-height322"
        ...
        iaa.CropToFixedSize(
            480, 322, name="crop-width480-height322"
        ),  # input size == output size
        ...
        iaa.Sequential(
            [iaa.PadToFixedSize(200, 200), iaa.CropToFixedSize(200, 200)],
            name="pad-crop-width200-height200",
        ),
        iaa.Sequential(
            [iaa.PadToFixedSize(400, 400), iaa.CropToFixedSize(400, 400)],
            name="pad-crop-width400-height400",
        ),
        iaa.Sequential(
            [iaa.PadToFixedSize(600, 600), iaa.CropToFixedSize(600, 600)],
            name="pad-crop-width600-height600",
        ),
        iaa.Sequential(
            [iaa.CropToFixedSize(200, 200), iaa.PadToFixedSize(200, 200)],
            name="crop-pad-width200-height200",
        ),
        iaa.Sequential(
            [iaa.CropToFixedSize(400, 400), iaa.PadToFixedSize(400, 400)],
            name="crop-pad-width400-height400",
        ),
        iaa.Sequential(
            [iaa.CropToFixedSize(600, 600), iaa.PadToFixedSize(600, 600)],
