...
def main():
    ...
    augs = [
        ...
        iaa.CropAndPad(
            percent=(0.01, 0.02, 0.03, 0.04), name="pad-by-001-002-003-004percent"
        ),
        ...
        iaa.CropAndPad(
            percent=(-0.01, -0.02, -0.03, -0.04), name="crop-by-001-002-003-004percent"
        ),
    ]
    ...
    augs_many = [
        ...
        iaa.CropAndPad(
            px=(0, 50), sample_independently=False, name="pad-by-0-to-50px-same"
        ),
        ...
        iaa.CropAndPad(
            px=((0, 50), (0, 50), (0, 50), (0, 50)), name="pad-by-0-to-50px-each"
        ),
        iaa.CropAndPad(
            percent=(0, 0.1),
